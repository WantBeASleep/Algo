...
![2pointersStack](/img/2pointersStack.png)
...
подобное ищется префиксными суммами $p_r > p_l && r - l >= D$ В данном случае достаточно хранить индекс минимальной префиксной суммы на отрезке [0, R-L]
